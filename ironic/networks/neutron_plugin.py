...
class NeutronV2NetworkProvider(base.NetworkProvider):
    ...
    def _remove_network(self, task, network_uuid):
        ...
        for port in task.ports:
            port_options = ['vif_port_id', 'tenant_vif_port_id']
            for port_option in port_options:
                if port_option in port.extra:
                    extra_dict = port.extra
                    extra_dict.pop(port_option, None)
    ...
    def remove_provisioning_network(self, task):
        ...
        :param task: A TaskManager instance.
        """
        self._remove_network(task, CONF.neutron.provisioning_network_uuid)
    ...
    def unconfigure_tenant_networks(self, task):
        ...
        Nova takes care of port removal from tenant network.
